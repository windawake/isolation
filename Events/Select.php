            ...
            if ($read) {
                foreach ($read as $fd) {
                    ...
                    if (isset($this->_allEvents[$fd_key][self::EV_READ])) {
                        /*Helper::log(array($this->_allEvents[$fd_key][self::EV_READ][0],
                            $this->_allEvents[$fd_key][self::EV_READ][1]),'[read]','select/read.log');*/
            ...
            if ($write) {
                foreach ($write as $fd) {
                    ...
                    if (isset($this->_allEvents[$fd_key][self::EV_WRITE])) {
                        /*Helper::log(array($this->_allEvents[$fd_key][self::EV_WRITE][0],
                            $this->_allEvents[$fd_key][self::EV_WRITE][1]),'[write]','select/write.log');*/
